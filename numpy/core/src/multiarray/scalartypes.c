#line 1 "/home/dan/Projects/numpy-presetup/numpy/core/src/multiarray/scalartypes.c.src"
...
finish:
    ...
    *((npy_byte *)dest) = *((npy_byte *)src);
    ...
    if (itemsize == 0) { /* unicode */
        /*XXX: Modified by Dan, did the right thing?*/
        /* itemsize is a terribly misleading name for this imho... */
        /*itemsize = ((PyUnicodeObject *)robj)->length * sizeof(Py_UNICODE);*/
        itemsize = PyUnicode_GetSize(robj) * sizeof(Py_UNICODE);
    }
